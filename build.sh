...
# MCU=atmega168  F_CPU=16000000L CORE=arduino VARIANT=eightanaloginputs - nano, mini, bt
...
# MCU=atmega32u4 F_CPU=16000000L CORE=arduino VARIANT=leonardo          - leonardo
# MCU=atmega32u4 F_CPU=16000000L CORE=arduino VARIANT=micro             - micro
...
make -f core.mk clean install MCU=atmega32u4 F_CPU=16000000L CORE=arduino VARIANT=leonardo           
make -f core.mk clean install MCU=atmega32u4 F_CPU=16000000L CORE=arduino VARIANT=micro              
...
make -f library.mk clean install NAME=EEPROM DEPS= MCU=atmega32u4 F_CPU=16000000L CORE=arduino VARIANT=micro
...
make -f library.mk clean install NAME=SPI DEPS= MCU=atmega32u4 F_CPU=16000000L CORE=arduino VARIANT=micro
...
make -f library.mk clean install NAME=Ethernet DEPS=SPI MCU=atmega32u4 F_CPU=16000000L CORE=arduino VARIANT=micro
...
make -f library.mk clean install NAME=Firmata DEPS= MCU=atmega32u4 F_CPU=16000000L CORE=arduino VARIANT=micro
...
make -f library.mk clean install NAME=LiquidCrystal DEPS= MCU=atmega32u4 F_CPU=16000000L CORE=arduino VARIANT=micro
...
make -f library.mk clean install NAME=SD DEPS= MCU=atmega32u4 F_CPU=16000000L CORE=arduino VARIANT=micro
...
make -f library.mk clean install NAME=Servo DEPS= MCU=atmega32u4 F_CPU=16000000L CORE=arduino VARIANT=micro
...
#make -f library.mk clean install NAME=SoftwareSerial DEPS= MCU=atmega32u4 F_CPU=16000000L CORE=arduino VARIANT=micro
...
make -f library.mk clean install NAME=Stepper DEPS= MCU=atmega32u4 F_CPU=16000000L CORE=arduino VARIANT=micro
...
make -f library.mk clean install NAME=Wire DEPS= MCU=atmega32u4 F_CPU=16000000L CORE=arduino VARIANT=micro
